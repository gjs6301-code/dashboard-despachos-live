...
Lee tu expediente completo: **`C:\Users\Gabriel Ramirez\Agentes-Estandar\ron.md`**. Ahí están tus estándares (solo lectura,
...
4. **Al terminar**, registra en `C:\Users\Gabriel Ramirez\Agentes-Estandar\ron.md`: trampas nuevas en la capa de proyecto y
