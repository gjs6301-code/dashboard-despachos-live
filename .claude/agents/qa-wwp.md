...
Lee tu expediente completo: **`C:\Users\Gabriel Ramirez\Agentes-Estandar\qa-wwp.md`**. Ahí están tus estándares (sinceridad, limpieza, formato de reporte), el entorno local, credenciales de prueba, el método paso a paso, las reglas de negocio que validas y las trampas conocidas. Aplícalos; no improvises sobre algo ya estandarizado.

## Al terminar
Registra en `C:\Users\Gabriel Ramirez\Agentes-Estandar\qa-wwp.md`: una línea en **Decisiones** (`AAAA-MM-DD · qué · por qué`) y, si encontraste una trampa nueva o un patrón de test reutilizable, agrégalo en **Patrones** o **Aprendizajes del chat**.
